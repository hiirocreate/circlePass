...
export default function OperatorLineSettingsPage() {
  ...
  return (
    <div className="space-y-4 p-4">
      <BackLink href="/admin" />
      <h1 className="text-lg font-bold">LINE通知設定 代理管理</h1>
      ...
      {selectedShopId && <LineCredentialsView shopId={selectedShopId} />}
    </div>
  );
}